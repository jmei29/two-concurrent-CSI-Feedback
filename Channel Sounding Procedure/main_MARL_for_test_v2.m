...
for ep_idx = 1 : parameters.num_episode_per_CASE
    ...
    while 1
        ...
        if CH_sounding_idx > 1
            ...
            action_result_for_STA = pyrunfile('MARL/MARL_STA_part_action.py', ...
                "output_for_MATLAB", episode_from_matlab = CH_sounding_idx,...
            ...
            data_size_CFI = 0;
            if CFI_type_index ~= 8 % CFI_type_index > 0 means feedback feature information
        ...
        if CH_sounding_idx > 1
            ...
            if if_trigger_CFI_Fed
                ...
                action_result_for_AP = pyrunfile('MARL/MARL_AP_part_action.py',...
                    "output_for_MATLAB", episode_from_matlab = CFI_fedback_idx,...
                    cache_length_from_matlab = 1,...
                    PDP_state_size_from_matlab = parameters.N_c,...
                    PAS_state_size_from_matlab = parameters.AP_antenna_num, ...
                    CSL_state_size_from_matlab = parameters.STA_antenna_num,...
...
savefile = sprintf('/Case_%d_CSI_fed_result_DQN_teset_CASE_%d.mat', parameters.CASE_IDX, training_CASE);
